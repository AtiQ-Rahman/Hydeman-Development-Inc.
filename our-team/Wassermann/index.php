...
<head>
    <title>Professor Neil Wasserman</title>
    <meta charset="utf-8" />
            ...
            <div class="container team-single-template">
                <div class="team-single-container">
                    <div class="team-single-contact">
                        <div class="team-single-contact__inner">
                            <div class="team-single-contact__image">
                                <a href="index.html">
                                    <img width="255" height="359" src="../../wp-content/uploads/2020/07/Wasserman.jpg"
                                        class="attachment-full size-full wp-post-image" alt="Wasserman"
                                        decoding="async" sizes="(max-width: 255px) 100vw, 255px" /> </a>
                            </div>
                            <!-- <p class="team-single-contact__email"><a
                                    href="mailto:wasserman@hydemandevelopments.com">wasserman@hydemandevelopments.com</a></p>
                    ...
                    <div class="team-single-content">
                        <h1>Professor Neil Wasserman</h1>
                        <p class="team-single-content__title">Head of IT, Blockchain and CTO</p>

                        <div class="team-single-content__body">
                            <p>Neil H. Wasserman (Ph.D.), Adjunct Prof. in Computer Science at George Washington University
                                (GW), and Managing Director, Timewave Analytics, LLC, leads the design and implementation of healthcare applications of blockchain and other technologies in the Washington DC region. He along
                                with his students have further developed designs and applications for usage in a wide variety of application domains including satellite tracking, land registration, trade authentication, currency stabilization, IoT device access and other areas. As a practice director for Unisys and lead consultant to the US Navy in the office of the NAVSEA CIO, he has been involved with IT strategic planning, enterprise architecture, systems analysis and software implementation for more than two decades.
                                 </p>
                        </div>
