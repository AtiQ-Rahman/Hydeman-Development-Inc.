                    ...
                    <div class="menu-services-nav-menu-container">
                        <ul id="menu-services-nav-menu" class="menu">
                            ...
                            <li id="menu-item-509"
                                ...
                                <a href="index.html" aria-current="page">Readymade <br>Garments</a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="footer-holder">
                    ...
                    <div class="subscribe-section">
                        ...
                        <div data-form-id="544" id="ctct-form-wrapper-0" class="ctct-form-wrapper">
                            <form class="ctct-form ctct-form-544 no-recaptcha myccform" id="ctct-form-472859103"
                                ...
                                <p class="ctct-form-field ctct-form-field-text ctct-form-field-required"><span
                                        class="ctct-label-hidden"><label
                                            for="first_name___e5f2eda0170f589845f0a61e6054d6b7_0_3862972602">First name
                                        ...
                                        id="first_name___e5f2eda0170f589845f0a61e6054d6b7_0_3862972602" /></p>
                                <p class="ctct-form-field ctct-form-field-email ctct-form-field-required"><span
                                        class="ctct-label-hidden"><label
                                            for="email___3ca1751aa3562a0d9466d0c6f671b420_0_272600812">Email (required)
                                        ...
                                        id="email___3ca1751aa3562a0d9466d0c6f671b420_0_272600812" /></p>
                                ...
                                <div class="ctct_usage"
                                    ...
                                    value="0" /><input type="hidden" name="ctct_time" value="1669822153" />
                                <p class="ctct-form-field ctct-form-field-submit"><input type="submit"
                                        ...
                                        id="ctct-submitted_0_366358983" /></p>
